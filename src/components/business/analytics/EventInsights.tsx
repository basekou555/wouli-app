...
const EventInsights: React.FC<EventInsightsProps> = ({
  ...
  return <Card className={className}>
      ...
      <CardContent className="space-y-4">
        {insights.map((insight, index) => <div key={index} className="flex items-start gap-3 p-3 rounded-lg border bg-card/50 transition-colors hover:bg-card">
            ...
            <div className="flex-grow space-y-2">
              ...
              {insight.action && <Button variant="ghost" size="sm" className="h-auto p-1 text-xs hover:bg-primary/5">
                  {insight.action}
