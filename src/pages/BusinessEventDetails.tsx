...
const BusinessEventDetails = () => {
  ...
  const handleEdit = () => {
    navigate(`/business/event/${id}/edit`, {
      state: {
        event
      }
    });
      ...
      <div className="bg-white shadow-sm p-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Button variant="ghost" onClick={() => navigate('/business')} className="mr-4">
          ...
          <div className="flex gap-2">
            <Button onClick={refreshAnalytics} variant="ghost" size="sm" disabled={analyticsLoading}>
      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            like_rate: 0,
            engagement_score: 0
          }} benchmark={benchmark} categoryRank={categoryRank} />
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {event.price && <div className="flex items-center text-gray-700">
                      <Euro className="h-5 w-5 mr-3 text-orange-500" />
                      <span>{event.price}</span>
                    </div>}

                  {event.external_url && <div className="flex items-center text-gray-700">
                      <ExternalLink className="h-5 w-5 mr-3 text-orange-500" />
                      <a href={event.external_url} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                        Billeterie / Réservation
                      </a>
                    </div>}

                  {event.description && <div className="mt-6">
