  ...
  return <BusinessLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button onClick={() => setShowCreateForm(!showCreateForm)} className="bg-primary hover:bg-primary/90" size="lg">
        ...
        {showCreateForm && <Card>
            ...
            <CardContent>
              <EventCreationForm config={config} onEventCreate={handleCreateEvent} editingEvent={editingEvent} onEventUpdate={handleUpdateEvent} onCancelEdit={handleCancelEdit} />
            </CardContent>
          </Card>}
        ...
        <Card>
          ...
          <CardContent>
            {loading ? <LoadingSpinner /> : error ? <ErrorMessage message={error.message} /> : <EventList config={config} events={events} onDeleteEvent={handleDeleteEvent} onEditEvent={handleEditEvent} />}
          </CardContent>
        </Card>
      </div>
    </BusinessLayout>;
