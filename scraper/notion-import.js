...
const CATEGORY_MAP = {
  ...
  'guinguette / p tanque': 'soirees',  // encodage corrompu
  'café-concert': 'soirees',
  'cafe-concert': 'soirees',
  'caf  concert': 'soirees',           // encodage corrompu
  ...
  'bar à jeux': 'a-boire',
  'bar   jeux': 'a-boire',             // encodage corrompu (à → espaces)
  'bar   jeux / festif': 'a-boire',    // encodage corrompu
  'bar à vin': 'a-boire',
  'bar   vin': 'a-boire',              // encodage corrompu
  'cave à vin': 'a-boire',
  'cave a vin': 'a-boire',
  'brasserie': 'a-boire',
