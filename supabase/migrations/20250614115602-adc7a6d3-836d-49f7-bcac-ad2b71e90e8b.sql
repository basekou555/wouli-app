...
-- Disable both foreign key constraints temporarily for demo data insertion
ALTER TABLE public.business_configs DROP CONSTRAINT IF EXISTS business_configs_user_id_fkey;
ALTER TABLE public.business_events DROP CONSTRAINT IF EXISTS business_events_user_id_fkey;

-- Insert demo business configurations with valid UUIDs (no foreign key constraint)
