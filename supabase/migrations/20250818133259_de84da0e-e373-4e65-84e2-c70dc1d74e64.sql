-- Phase 2: Backend Stabilization - Ajout des colonnes de statut et d'archivage

-- Ajouter les colonnes manquantes à la table events
ALTER TABLE public.events 
ADD COLUMN IF NOT EXISTS status text DEFAULT 'active' CHECK (status IN ('active', 'archived', 'cancelled')),
